 ...
 *
 * Defines GPIO assignments and configuration for the Production Loop
 * Soak example. Based on WisCore_RAK4631_Board variant.h.
 *
 * Source: Hardware Profile v3.7 (RAK4631)
 */
...
/* ---- Production Soak Configuration ---- */
#define SOAK_DURATION_MS           300000   /* 5 minutes */
#define SOAK_MIN_UPLINKS           3        /* Conservative — minimum successful uplinks */
#define SOAK_MAX_CONSEC_FAILS      2        /* Max consecutive modbus or uplink failures */
#define SOAK_MAX_CYCLE_MS          1500     /* Max acceptable cycle duration */
